...
// Zber metrík vieme vypnúť cez premennú prostredia, ak chceme čo
// najjednoduchší beh servera bez dodatočných zápisov na disk.
...
// na jeden riadok. Takýto formát je vhodný na neskoršie filtrovanie
// aj dávkové spracovanie.
...
function genId(prefix: string) {
  ...
  // nasadzovať samostatnú knižnicu pre distribuované trasovanie.
  return `${prefix}_${Math.random().toString(16).slice(2)}_${Date.now().toString(16)}`;
}

// Ak klient pošle vlastné trace ID, zachováme ho, aby bolo možné
// prepájať logiku klienta, servera aj lokálneho agenta. Inak vytvoríme nové.
...
// spotrebu CPU, zmenu pamäte a výsledný stav. Vďaka tomu máme presný prehľad
// o tom, ktorá časť serverovej logiky je najnáročnejšia.
...
// Middleware automaticky meria každú HTTP požiadavku, takže máme prehľad
// nielen o vnútorných krokoch v biznis logike, ale aj o celkovom čase
// spracovania requestu na úrovni Expressu.
